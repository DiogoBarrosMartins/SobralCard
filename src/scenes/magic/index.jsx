...
import CardListDisplay from '../../components/ListCard';
    ...
    return (
        <Box m="20px">
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center">
                <Header title="Magic Search" subtitle="Welcome to your MAGIC dashboard, search a card " />
                <Box>
                    <Button
                        sx={{
            ...
            >
                ...
                {/* MTG CARD DISPLAY */}
                <Box gridColumn="span 6" gridRow="span 2" backgroundColor={colors.primary[400]} p="20px">
                ...
                <Box gridColumn="span 6" gridRow="span 2" backgroundColor={colors.primary[400]} p="20px">
                    ...
                    <CardListDisplay searchInput="dragon" />
                </Box>
